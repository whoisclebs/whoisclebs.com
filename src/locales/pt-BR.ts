export const ptBR = {
  ...
  home: {
    ...
    nowTitle: 'AGORA',
    nowItems: [
      'Um orquestrador de agentes em Go.',
      'Runtimes, WASM e sistemas distribuídos.',
      'Uma pilha de notas que ainda precisa virar texto.',
    ],
    nowLabels: ['CONSTRUINDO', 'ESTUDANDO', 'LENDO'],
    nowUpdated: 'ATUALIZADO EM 02 JUL. 2026',
