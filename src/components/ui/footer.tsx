    ...
    <footer className="border-t border-black bg-[#1a1a1a] px-4 py-12 text-white md:px-6">
      <div className="mx-auto w-full max-w-[1280px]">
        ...
        <div className="mb-4 flex flex-wrap gap-3 font-mono text-xs uppercase tracking-[0.06em] text-zinc-300">
          <Link className="transition-colors hover:text-white hover:underline hover:underline-offset-4" to={localizedPath('/privacy-policy')}>{t('footer.privacy')}</Link>
          <span aria-hidden="true">/</span>
          <Link className="transition-colors hover:text-white hover:underline hover:underline-offset-4" to={localizedPath('/terms-of-use')}>{t('footer.terms')}</Link>
        </div>
