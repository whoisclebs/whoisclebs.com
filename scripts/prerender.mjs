...
function getSeoForRoute(route, ptPosts, enPosts, tilEntries) {
  ...
  const staticPages = {
    ...
    '/about': {
      locale: 'pt-BR', title: `Sobre – ${siteName}`, description: 'Conheça mais sobre Clebson A. Fonseca, engenheiro de software.', jsonLd: personJsonLd,
    },
    '/blog': {
    ...
    '/portfolio': {
      locale: 'pt-BR', title: `Portfólio – ${siteName}`, description: 'Projetos e trabalhos de Clebson A. Fonseca.', jsonLd: personJsonLd,
    },
    '/hobbies': {
      locale: 'pt-BR', title: `Hobbies – ${siteName}`, description: 'Interesses pessoais e hobbies de Clebson A. Fonseca.', jsonLd: personJsonLd,
    },
    '/books': {
      locale: 'pt-BR', title: `Livros – ${siteName}`, description: 'Livros que Clebson A. Fonseca leu ou está lendo.', jsonLd: personJsonLd,
    },
    '/privacy-policy': {
      locale: 'pt-BR', title: `Política de Privacidade – ${siteName}`, description: 'Política de privacidade do site whoisclebs.com.',
      jsonLd: { '@context': 'https://schema.org', '@type': 'WebPage', name: `Política de Privacidade – ${siteName}`, description: 'Política de privacidade do site whoisclebs.com.' },
    },
    '/terms-of-use': {
      locale: 'pt-BR', title: `Termos de Uso – ${siteName}`, description: 'Termos de uso do site whoisclebs.com.',
      jsonLd: { '@context': 'https://schema.org', '@type': 'WebPage', name: `Termos de Uso – ${siteName}`, description: 'Termos de uso do site whoisclebs.com.' },
    },
    '/404': {
    ...
    '/en/': {
      locale: 'en', title: `${siteName} – Software engineering without theater`,
      description: 'Blog and portfolio of Clebson A. Fonseca about software engineering, architecture, payments, frontend, and operations.',
      jsonLd: [personJsonLd, websiteJsonLd],
    },
    '/en/about': {
      locale: 'en', title: `About – ${siteName}`, description: 'Learn more about Clebson A. Fonseca, software engineer.', jsonLd: personJsonLd,
    },
    '/en/blog': {
    ...
    '/en/portfolio': {
      locale: 'en', title: `Portfolio – ${siteName}`, description: 'Projects and work by Clebson A. Fonseca.', jsonLd: personJsonLd,
    },
    '/en/hobbies': {
      locale: 'en', title: `Hobbies – ${siteName}`, description: 'Personal interests and hobbies of Clebson A. Fonseca.', jsonLd: personJsonLd,
    },
    '/en/books': {
      locale: 'en', title: `Books – ${siteName}`, description: 'Books Clebson A. Fonseca has read or is reading.', jsonLd: personJsonLd,
    },
    '/en/privacy-policy': {
      locale: 'en', title: `Privacy Policy – ${siteName}`, description: 'Privacy policy for whoisclebs.com.',
      jsonLd: { '@context': 'https://schema.org', '@type': 'WebPage', name: `Privacy Policy – ${siteName}`, description: 'Privacy policy for whoisclebs.com.' },
    },
    '/en/terms-of-use': {
      locale: 'en', title: `Terms of Use – ${siteName}`, description: 'Terms of use for whoisclebs.com.',
      jsonLd: { '@context': 'https://schema.org', '@type': 'WebPage', name: `Terms of Use – ${siteName}`, description: 'Terms of use for whoisclebs.com.' },
    },
  }
